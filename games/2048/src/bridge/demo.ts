...
const KEY_SCORE = '2048:demo:lastScore';
...
export function createDemoApi(): ApiClient {
  return {
    ...
    async leaderboard(_gameId: string, limit = 10): Promise<LeaderboardEntry[]> {
      ...
      const fake = [
        { name: 'Sardor', score: 18420 }, { name: 'Malika', score: 15960 },
        { name: 'Jasur', score: 12480 }, { name: 'Nigora', score: 9720 },
        { name: 'Bekzod', score: 7160 }, { name: 'Dilnoza', score: 5240 },
      ];
