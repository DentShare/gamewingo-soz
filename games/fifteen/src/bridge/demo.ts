...
const KEY_SCORE = 'fifteen:demo:lastScore';
...
export function createDemoApi(): ApiClient {
  return {
    ...
    async leaderboard(_gameId: string, limit = 10): Promise<LeaderboardEntry[]> {
      ...
      const fake = [
        { name: 'Sardor', score: 3720 }, { name: 'Malika', score: 3410 },
        { name: 'Jasur', score: 3050 }, { name: 'Nigora', score: 2590 },
        { name: 'Bekzod', score: 2120 }, { name: 'Dilnoza', score: 1480 },
      ];
