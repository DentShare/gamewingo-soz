...
export class MainMenu extends Scene {
  ...
  create() {
    ...
    // Обещание игры: за каждой собранной картинкой — своя история.
    this.add
      .text(CX, 182, t(this.locale, 'menu.hint'), {
    ...
    // Лестница картинок: собранные со звёздами, следующая выделена, дальше — замки.
    ...
    const grid = makeLevelGrid(this, CX, 216, tiles, (n) => this.startLevel(n));

    const belowGrid = 216 + grid.height + 30;
