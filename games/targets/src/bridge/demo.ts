...
const KEY_SCORE = 'targets:demo:lastScore';
...
export function createDemoApi(): ApiClient {
  return {
    ...
    async leaderboard(_gameId: string, limit = 10): Promise<LeaderboardEntry[]> {
      ...
      const fake = [
        { name: 'Sardor', score: 11240 }, { name: 'Malika', score: 9680 },
        { name: 'Jasur', score: 8150 }, { name: 'Nigora', score: 6720 },
        { name: 'Bekzod', score: 5390 }, { name: 'Dilnoza', score: 4180 },
      ];
