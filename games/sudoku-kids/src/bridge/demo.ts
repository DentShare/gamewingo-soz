...
const KEY_SCORE = 'sudoku:demo:lastScore';
...
export function createDemoApi(): ApiClient {
  return {
    ...
    async leaderboard(_gameId: string, limit = 10): Promise<LeaderboardEntry[]> {
      ...
      const fake = [
        { name: 'Sardor', score: 4310 }, { name: 'Malika', score: 3980 },
        { name: 'Jasur', score: 3540 }, { name: 'Nigora', score: 2870 },
        { name: 'Bekzod', score: 2260 }, { name: 'Dilnoza', score: 1720 },
      ];
