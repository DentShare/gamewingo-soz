...
| Шрифт Rubik (сабсеты latin+cyrillic 500 и 600) | fonts.google.com/specimen/Rubik | OFL 1.1 | сохранить копирайт/OFL, не продавать сам шрифт | хаб каталога (заголовки, кнопки) | 2026-07-29 | — |
| Иконки игр в хабе | собственная векторная отрисовка (инлайн-SVG) | — (собственная) | без сторонних прав | хаб каталога | 2026-07-29 | — |
