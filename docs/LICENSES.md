...
| Звуки интерфейса (8 эффектов) | kenney.nl/assets/interface-sounds, пак «Interface Sounds 1.0»; файл лицензии сохранён в `packages/game-ui/audio/LICENSE.txt` | CC0 1.0 | без условий, атрибуция не требуется; перекодированы в моно mp3 (`ffmpeg -ac 1 -ar 44100 -b:a 96k -c:a libmp3lame`) | все игры каталога | 2026-08-08 | — |
|  |  |  |  |  |  |  |
